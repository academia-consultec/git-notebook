...
- usamos **git tag v1.0** para asignar el tag.
- usamos **git tag -s v1.0** envia un parametro al comando para firmar los tags.
- usamos **git push -tags** para publicar los tags
- usamos **git show v1.0** para mostrar informacion de un tag como si fuera un git log.
